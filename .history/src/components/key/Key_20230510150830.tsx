...
const Key: React.FC<Ikey> = ({ letter, index }) => {
  if (index === 2) {
    return(<span className="flex items-center justify-center bg-[#dce1ed] rounded text-lg text-#414a5e border-2 border-transparent flex-1 h-[46px] p-4 cursor-pointer font-bold">
      <svg
