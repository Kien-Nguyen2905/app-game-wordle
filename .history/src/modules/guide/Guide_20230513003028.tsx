...
const Guide: React.FC<Iguide> = ({ open = false }) => {
  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="absolute z-20 h-[630px] w-[300px] bg-transparent">
        <h3 className=" relative flex min-h-[38px] w-full items-center justify-center rounded-md bg-[#e5ecff] text-lg font-bold">
          How to play
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="my-2 min-w-[300px] rounded-lg bg-[#edf0f5] px-[15px] py-[10px]">
            <div className="flex items-end">
              <span className="wrong boder-[#dee1e9] flex items-center justify-center rounded-lg border-2 bg-[#fbfcff] px-[8px] py-[2px] text-[10px] font-bold">
                T
              </span>
              <span className="px-1">,</span>
              <span className="wrong boder-[#dee1e9] flex items-center justify-center rounded-lg border-2 bg-[#fbfcff] px-[8px] py-[2px] text-xs font-bold">
                B
              </span>
