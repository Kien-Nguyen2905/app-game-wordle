      ...
      <div className="absolute z-20 h-[630px] w-[560px] bg-transparent">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center gap-2">
            <div className="wrong boder-[#dee1e9] flex h-[56px] w-[56px] items-center justify-center rounded-lg border-2 bg-[#fbfcff] text-[28px] font-bold">
              T
            </div>
            <div className="spot boder-[#dee1e9] flex h-[56px] w-[56px] items-center justify-center rounded-lg border-2 bg-[#fbfcff] text-[28px] font-bold">
              A
            </div>
            <div className="wrong boder-[#dee1e9] flex h-[56px] w-[56px] items-center justify-center rounded-lg border-2 bg-[#fbfcff] text-[28px] font-bold">
              B
            ...
            <div className="correct boder-[#dee1e9] flex h-[56px] w-[56px] items-center justify-center rounded-lg border-2 bg-[#fbfcff] text-[28px] font-bold">
              E
            </div>
          </div>
          <div className="rounded-md bg-[#edf0f5] px-[15px] py-[10px]"></div>
        </div>
      </div>
    </div>,
    container
