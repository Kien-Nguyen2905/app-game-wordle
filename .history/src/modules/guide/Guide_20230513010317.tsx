...
const Guide: React.FC<IGuide> = ({ open = false, handleClose = () => {} }) => {
  ...
  return ReactDOM.createPortal(
    ...
    >
      ...
      <div className="absolute z-20 h-[600px] w-[300px] bg-transparent">
        <h3 className=" relative flex min-h-[38px] w-full items-center justify-center rounded-md bg-[#e5ecff] text-lg font-bold">
          How to play
          <button className="absolute right-0 pr-2" onClick={handleClose}>
            <svg
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="my-3 flex min-w-[340px] flex-col gap-2 rounded-lg bg-[#edf0f5] px-[15px] py-[10px]">
            <div className="flex items-end">
              ...
              <p className="pl-1 text-xs text-[#2e3239]">
          ...
          <p className=" mb-4 text-center text-sm text-[#2e3239]">
          ...
          <p className="mt-3 text-lg font-semibold text-center">Got it! 🏆</p>
        </div>
      </div>
    </div>,
    container
